...
- added an Operational V1 pattern candidate map and tri-repo backflow compliance record, freezing neutral runtime/projection/governance candidates derived from SoloCrew’s sealed bounded loop without runtime implementation or schema change
