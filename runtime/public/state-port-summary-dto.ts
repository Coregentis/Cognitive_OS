...
export type StatePortPostureDto =
  | "available"
  | "blocked"
  | "deferred"
  | "summary_only"
...
export type StatePortBoundaryProfile = {
...
export type StatePortSummaryDto = {
  state_port_summary_id: string;
  contract_version: RuntimePublicSurfaceContractVersion;
  runtime_contract_version: RuntimePublicSurfaceRuntimeContractVersion;
  compatibility_profile: RuntimePublicSurfaceCompatibilityProfile;
  source_runtime_surface_ref: string;
  source_commit_ref: string;
  port_mode: StatePortModeDto;
  supported_persistence_modes: readonly StatePortModeDto[];
  storage_posture_summary: string;
  roundtrip_support_summary: string;
  state_port_posture: StatePortPostureDto;
  ...
  boundary_flags: StatePortBoundaryProfile;
};
