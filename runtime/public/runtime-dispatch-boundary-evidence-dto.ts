...
export type RuntimeDispatchPermissionSummaryDto = {
  permission_summary_ref: string;
  dispatch_posture_summary: string;
  blocked_dispatch_targets: readonly string[];
  rejection_reason_summary: string;
  runtime_private_fields_omitted: true;
};

export type RuntimeDispatchBoundaryProfile = {
...
export type RuntimeDispatchBoundaryEvidenceDto = {
  dispatch_boundary_evidence_id: string;
  contract_version: RuntimePublicSurfaceContractVersion;
  runtime_contract_version: RuntimePublicSurfaceRuntimeContractVersion;
  compatibility_profile: RuntimePublicSurfaceCompatibilityProfile;
  ...
  blocked_dispatch_targets: readonly string[];
  rejection_reason_summary: string;
  permission_summary: RuntimeDispatchPermissionSummaryDto;
  ...
  runtime_private_fields_omitted: true;
  boundary_flags: RuntimeDispatchBoundaryProfile;
};
