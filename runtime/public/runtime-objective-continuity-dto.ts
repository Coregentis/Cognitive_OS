...
export type ObjectiveComparisonStatusDto =
  | "aligned"
  | "changed"
  | "conflicting"
...
export type ObjectiveContinuityRecommendationPostureDto =
  | "continue"
...
export type ObjectiveContinuityBoundaryProfile = {
...
export type ObjectiveComparisonSummaryDto = {
  objective_ref: string;
  comparison_status: ObjectiveComparisonStatusDto;
  previous_objective_summary_ref: string;
  current_objective_summary_ref: string;
  continuity_rationale_summary: string;
  safe_evidence_refs: readonly RuntimePublicSurfaceEvidenceRefDto[];
  runtime_private_fields_omitted: true;
};

export type ObjectiveContinuityDto = {
  objective_continuity_id: string;
  objective_ref: string;
  comparison_status: ObjectiveComparisonStatusDto;
  previous_objective_summary_ref: string;
  current_objective_summary_ref: string;
  continuity_recommendation_posture: ObjectiveContinuityRecommendationPostureDto;
  continuity_rationale_summary: string;
  safe_evidence_refs: readonly RuntimePublicSurfaceEvidenceRefDto[];
  contract_version: RuntimePublicSurfaceContractVersion;
  runtime_contract_version: RuntimePublicSurfaceRuntimeContractVersion;
  ...
  runtime_private_fields_omitted: true;
  boundary_flags: ObjectiveContinuityBoundaryProfile;
};
