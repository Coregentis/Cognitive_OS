...
export type RuntimeSessionCreationPostureDto =
  | "not_evaluated"
  | "summary_only"
  | "creation_supported"
  | "creation_deferred"
...
export type RuntimeSessionEvidenceBoundaryProfile = {
...
export type RuntimeSessionEvidenceDto = {
  runtime_session_evidence_id: string;
  contract_version: RuntimePublicSurfaceContractVersion;
  runtime_contract_version: RuntimePublicSurfaceRuntimeContractVersion;
  compatibility_profile: RuntimePublicSurfaceCompatibilityProfile;
  source_runtime_surface_ref: string;
  source_commit_ref: string;
  creation_posture: RuntimeSessionCreationPostureDto;
  ...
  runtime_private_fields_omitted: true;
  boundary_flags: RuntimeSessionEvidenceBoundaryProfile;
};
